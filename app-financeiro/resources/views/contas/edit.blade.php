<x-app-layout>
    @section('title', $origens->find(session('origem_id'))->nome_canal ?? 'Conta')
                ...
                <section>
                    ...
                    <form method="post" action="{{ route('contas.update', [$conta]) }}"
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="nome" name="nome" type="text" autocomplete="nome" value="{{old('nome', $conta->nome)}}"
                                       autofocus
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="referencia_no_canal_de_venda" name="referencia_no_canal_de_venda" type="text"
                                       ...
                                       value="{{old('referencia_no_canal_de_venda', $conta->referencia_no_canal_de_venda)}}"
                        ...
                        <div>
                            <label for="comissao"
                                   class="block text-sm font-medium leading-6 text-primary-900">Comissão do Marketplace (%)</label>
                            <div class="mt-2">
                                <input id="comissao" name="comissao" type="text"
                                       autocomplete="comissao"
                                       value="{{old('comissao', $conta->comissao['mkt'])}}"
                        ...
                        <input id="origem_id" name="origem_id" type="hidden"
                               value="{{old('origem_id', $conta->origem_id)}}" />
    ...
    @push('scripts')
        <script type="module">
            ...
            @if (session('status') == 'conta-created')
            Swal.fire({
                toast: true,
                position: 'top-end',
                icon: 'success',
            ...
            @if (session('status') == 'conta-updated')
            Swal.fire({
                toast: true,
                position: 'top-end',
                icon: 'success',
